...
public class map extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final mapDB db= new mapDB(getApplicationContext(),"MAP.db",null,1);
        arr=db.getLatLng(0);
        if(insert_db(db,arr))
            arr=db.getLatLng(0);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.", Snackbar.LENGTH_INDEFINITE).setAction("확인", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( map.this, REQUIRED_PERMISSIONS, PERMISSIONS_REQUEST_CODE);
                    }
                }).show();
            } else {
    ...
    public boolean insert_db(mapDB db, double arr[][]){
        if(arr[0][0]==0){
